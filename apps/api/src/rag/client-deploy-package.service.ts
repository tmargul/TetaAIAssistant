...
export class ClientDeployPackageService {
  ...
  private async writeClientInstallFiles(appDir: string, appVersion: string): Promise<void> {
    ...
    const installBat = [
      ...
      'echo Otworz przegladarke: %~dp0Start-App.bat',
      'exit /b 0',
    ].join('\r\n');
  ...
  private async writeClientOnlineInstallFiles(appDir: string, appVersion: string): Promise<void> {
    const readme = [
      ...
      '5. Po zakonczeniu kliknij: Start-App.bat w tym katalogu (otwiera przegladarke; API dziala jako usluga Windows)',
      '6. Otworz przegladarke: http://localhost:3000',
      '',
      '=== PROBLEMY? ===',
      '',
      'Diagnostyka: scripts\\setup\\Diagnose-TetaApp.ps1',
      'Backend: usluga Windows TetaAI-API (services.msc), logi: .\\logs',
      '',
    ...
    const installBat = [
      ...
      'echo Uruchom aplikacje: %~dp0Start-App.bat  (otwiera przegladarke)',
  ...
  private async writeVendorInstallFiles(appDir: string, appVersion: string): Promise<void> {
    const readme = [
      ...
      '3. Po zakonczeniu uruchom: Start-App.bat w katalogu instalacji',
  ...
  private async writeVendorOnlineInstallFiles(appDir: string, appVersion: string): Promise<void> {
    const readme = [
      ...
      '5. Po zakonczeniu uruchom: Start-App.bat w katalogu instalacji',
      '6. Otworz przegladarke: http://localhost:3000',
      '',
      '=== PIERWSZE URUCHOMIENIE ===',
      '',
